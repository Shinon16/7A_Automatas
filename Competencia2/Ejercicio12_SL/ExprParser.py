...
def serializedATN():
    return [
        4,1,22,14,2,0,7,0,2,1,7,1,1,0,1,0,1,0,1,1,5,1,9,8,1,10,1,12,1,12,
        9,1,1,1,0,0,2,0,2,0,1,1,0,1,21,12,0,4,1,0,0,0,2,10,1,0,0,0,4,5,3,
...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'public'", "'class'", "'static'", "'void'", 
                     "'int'", "'String'", "'if'", "<INVALID>", "<INVALID>", 
                     "<INVALID>", "'='", "'+'", "'>='", "'.'", "';'", "'('", 
                     "')'", "'{'", "'}'", "'['", "']'" ]

    symbolicNames = [ "<INVALID>", "PUBLIC", "CLASS", "STATIC", "VOID", 
                      "INT", "STRING", "IF", "NUM", "CADENA", "ID", "IGUAL", 
    ...
    class ExprContext(ParserRuleContext):
        ...
        def MAYOR_IGUAL(self, i:int=None):
            if i is None:
                return self.getTokens(ExprParser.MAYOR_IGUAL)
            else:
                return self.getToken(ExprParser.MAYOR_IGUAL, i)
