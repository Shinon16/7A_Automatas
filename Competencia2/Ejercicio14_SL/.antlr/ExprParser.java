// Generated from d:/7A_Automatas/Competencia2/Ejercicio14_SL/Expr.g4 by ANTLR 4.13.1
...
public class ExprParser extends Parser {
	...
	public static final int
		...
		INNER=16, JOIN=17, ON=18, WHERE=19, UPDATE=20, SET=21, NUM=22, CADENA=23, 
		ID=24, ASIG=25, COMA=26, MAS=27, MAYOR_IGUAL=28, PUNTO=29, PUNTO_COMA=30, 
		PAR_IZQ=31, PAR_DER=32, LLAVE_IZQ=33, LLAVE_DER=34, COR_IZQ=35, COR_DER=36, 
		ASTERISCO=37, WS=38;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'SELECT'", "'FROM'", "'INNER'", "'JOIN'", "'ON'", "'WHERE'", "'UPDATE'", 
			"'SET'", null, null, null, "'='", "','", "'+'", "'>='", "'.'", "';'", 
			"'('", "')'", "'{'", "'}'", "'['", "']'", "'*'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INNER", "JOIN", "ON", "WHERE", "UPDATE", "SET", "NUM", "CADENA", "ID", 
			"ASIG", "COMA", "MAS", "MAYOR_IGUAL", "PUNTO", "PUNTO_COMA", "PAR_IZQ", 
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> UPDATE() { return getTokens(ExprParser.UPDATE); }
		public TerminalNode UPDATE(int i) {
			return getToken(ExprParser.UPDATE, i);
		}
		public List<TerminalNode> SET() { return getTokens(ExprParser.SET); }
		public TerminalNode SET(int i) {
			return getToken(ExprParser.SET, i);
		}
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 145626234878L) != 0)) {
				{
				{
				setState(7);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 145626234878L) != 0)) ) {
