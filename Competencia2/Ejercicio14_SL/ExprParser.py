...
def serializedATN():
    return [
        4,1,38,14,2,0,7,0,2,1,7,1,1,0,1,0,1,0,1,1,5,1,9,8,1,10,1,12,1,12,
        9,1,1,1,0,0,2,0,2,0,1,3,0,1,26,29,32,37,37,12,0,4,1,0,0,0,2,10,1,
...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'CREATE'", "'TABLE'", "'SERIAL'", "'PRIMARY'", 
                     ...
                     "'FROM'", "'INNER'", "'JOIN'", "'ON'", "'WHERE'", "'UPDATE'", 
                     "'SET'", "<INVALID>", "<INVALID>", "<INVALID>", "'='", 
                     "','", "'+'", "'>='", "'.'", "';'", "'('", "')'", "'{'", 
                     "'}'", "'['", "']'", "'*'" ]
    ...
    symbolicNames = [ "<INVALID>", "CREATE", "TABLE", "SERIAL", "PRIMARY", 
                      ...
                      "JOIN", "ON", "WHERE", "UPDATE", "SET", "NUM", "CADENA", 
    ...
    class ExprContext(ParserRuleContext):
        ...
        def UPDATE(self, i:int=None):
            if i is None:
                return self.getTokens(ExprParser.UPDATE)
            else:
                return self.getToken(ExprParser.UPDATE, i)

        def SET(self, i:int=None):
            if i is None:
                return self.getTokens(ExprParser.SET)
            else:
                return self.getToken(ExprParser.SET, i)
    ...
    def expr(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 145626234878) != 0):
                self.state = 7
                _la = self._input.LA(1)
                if not((((_la) & ~0x3f) == 0 and ((1 << _la) & 145626234878) != 0)):
